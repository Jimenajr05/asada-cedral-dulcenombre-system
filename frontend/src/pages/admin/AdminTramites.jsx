...
function AdminTramites() {
  ...
  const cargarTramites = async () => {
    try {
      ...
      alert(error.message || "Error al cargar trámites");
    } finally {
      setLoading(false);
    }
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const requisitos = form.requisitosTexto
      .split("\n")
      .map((item) => item.trim())
      .filter(Boolean);
    ...
    try {
      ...
      alert(error.message || "Error al guardar trámite");
    }
  };
  ...
  const handleEliminar = async (id) => {
    const confirmar = window.confirm("¿Deseas eliminar este trámite?");
    if (!confirmar) return;
    ...
    try {
      ...
      alert(error.message || "Error al eliminar trámite");
    }
  };
      ...
      <div className="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        <div>
          ...
          <p className="mt-2 text-lg text-slate-700">
            Administra los trámites y archivos descargables del sitio.
          </p>
        </div>
          ...
          <div className="mb-6 flex items-center justify-between gap-3">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-2xl font-bold text-slate-900">
                {editandoId ? "Editar trámite" : "Nuevo trámite"}
              </h2>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <p className="mt-2 text-sm text-slate-500">
                El botón público siempre mostrará{" "}
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-slate-500">
                {tramitesFiltrados.length} resultado
                      ...
                      >
                        <td className="px-4 py-4">
                          ...
                          <p className="mt-1 text-xs text-slate-500">
                            Botón público: Descargar Formulario
                          </p>
                        </td>
                            ...
                            <ul className="space-y-1">
                              ...
                              {tramite.requisitos.length > 3 && (
                                <li className="text-xs text-slate-500">
                                  + {tramite.requisitos.length - 3} requisito(s)
                                  más
                                </li>
                              )}
                            </ul>
                        ...
                        <td className="px-4 py-4 text-sm">
                          {tramite.archivoUrl ? (
                            <a
                              href={construirUrlArchivo(tramite.archivoUrl)}
                              target="_blank"
                              rel="noreferrer"
                        ...
                        <td className="px-4 py-4">
                          <div className="flex justify-end gap-2">
                            ...
                            <button
                              type="button"
                              onClick={() => handleEliminar(tramite._id)}
