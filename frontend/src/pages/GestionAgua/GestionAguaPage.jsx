    ...
    <div className="bg-slate-50">
      ...
      <section className="max-w-7xl mx-auto px-4 py-16">
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-bold mt-3">Proceso del Agua</h2>
        </div>

        <div className="grid md:grid-cols-4 gap-5">
          {proceso.map((p) => (
            <div key={p.titulo} className="bg-white p-6 rounded-xl shadow-sm text-center">
      ...
      <section className="bg-white py-16">
        <div className="max-w-7xl mx-auto grid lg:grid-cols-2 gap-10 px-4">
          ...
          <div className="bg-slate-50 p-6 rounded-xl">
            <h3 className="font-bold mb-6">Parámetros de Calidad</h3>
      ...
      {/* INFRAESTRUCTURA */}
      <section className="max-w-7xl mx-auto px-4 py-16">
        <h2 className="text-center text-3xl font-bold mb-10">Infraestructura</h2>

        <div className="grid md:grid-cols-3 gap-5">
          {infraestructura.map((i) => (
            <div key={i.titulo} className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold mb-4">{i.titulo}</h3>
        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-5">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold mb-4">En el Hogar</h3>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <h3 className="font-bold mb-4">En el Jardín</h3>
              <ul className="space-y-2 text-sm">
